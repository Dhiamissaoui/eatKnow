  ...
  exports.getAllPlats = async (req, res) => {
    try {
      ...
      console.log('📥 GET /api/plats - Query params:', req.query);
      ...
      // REMOVE .populate() - it's causing the issue
      const plats = await Plat.find(query);
      
      console.log(`✅ Found ${plats.length} plats`);
      ...
      console.error('❌ Error in getAllPlats:', error);
